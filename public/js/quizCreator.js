...
socket.on('connect',function(){
    if(params.id == undefined){
        ...
        document.getElementById('submitButton').setAttribute("onclick","updateDatabase('edit')");
...
function updateDatabase(reqtype){
    var questions = [];
    ...
    for(var i = 1; i <= questionNum; i++){
        ...
        switch(qtype){
            ...
            questions.push({"question": question, "answers": answers, "correct": correct, "type":qtype})
        }
