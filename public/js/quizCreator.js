...
function fetchQuestion() {
    {
        ...
        var question = document.getElementById('q' + questionNum).value;
        var answer1 = document.getElementById(questionNum + 'a1').value;
        var answer2 = document.getElementById(questionNum + 'a2').value;
        var answer3 = document.getElementById(questionNum + 'a3').value;
        var answer4 = document.getElementById(questionNum + 'a4').value;
        var answer = document.getElementById('correct' + questionNum).value;
        // questionTable = document.getElementById('allQuestions').innerHTML;
        questionTable = '';
        
        questionTable = preQuestionTable + `
        <h3>Question ${questionNum} :</h3>
          ...
          <div id="4 choices${questionNum}" class="tabcontent${questionNum}"><br>
            ...
            <label class = "question" id = "q${questionNum}" type = "text" autofocus/>${question}</label>
            <br>
            <br>
            <label>Answer 1: </label>
            <label id = "${questionNum}a1" type = "text" autofocus/>${answer1}</label>
            <br><br>
            <label>Answer 2: </label>
            <label id = "${questionNum}a1" type = "text" autofocus/>${answer2}</label>
            <br><br>
            <label>Answer 3: </label>
            <label id = "${questionNum}a1" type = "text" autofocus/>${answer3}</label>
            <br><br>
            <label>Answer 4: </label>
            <label id = "${questionNum}a1" type = "text" autofocus/>${answer4}</label>
            <br>
            <br>
            <label>Correct Answer (1-4) :</label>
            <label class = "correct" id = "correct${questionNum}"  type = "number" autofocus/>${answer}</label>
            <label id = "${questionNum}a1" type = "text" autofocus/></label>
        </div>
        ...
        <br>`;
        preQuestionTable = questionTable;
...
function addQuestion() {
    if (questionNum >= 1) fetchQuestion();
    questionNum += 1;
    questionTable = document.getElementById('allQuestions').innerHTML;
    questionTable += `
    <h3>Question ${questionNum} :</h3>
